...
auto"
            >
              At IntelliHire, we're dedicated to revolutionizing the job search
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg md:text-xl opacity-80">
              Join thousands of successful job seekers on IntelliHire
            </p>
            <div className="pt-4">
              <Link href="/jobs">
